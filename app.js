new Vue({
    ...
    data: {
        items: [
            ...
            { name: 'Breakfast Special', description: 'Good for you', image: 'https://upload.wikimedia.org/wikipedia/commons/0/02/Breakfast_at_Irving_Street_Kitchen.jpg' },
            ...
            { name: 'Filet Mignon', description: 'Juicy steak with potatoes au gratin', image: 'https://upload.wikimedia.org/wikipedia/commons/1/1a/.Filet_mignon_et_foie_gras_au_muscat_de_Beaumes-de-Venise%2C_Pastis_Bistro%2C_Palo_Alto.jpg' },
            ...
            { name: 'Top Burger', description: 'The tallest hamburger from Paris', image: 'https://upload.wikimedia.org/wikipedia/commons/d/d4/Hamburguesa_de_carne.jpg' },
            { name: 'Chicken Garlic Pizza', description: 'Our specialty pizza', image: 'https://upload.wikimedia.org/wikipedia/commons/3/33/Round_Table_chicken_%26_garlic_pizza.JPG' },
